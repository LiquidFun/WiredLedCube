...
namespace T27
{
    ...
    void test_max()
    {
        ...
        // INT_MIN and INT_MAX
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MIN, INT_MAX));
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MAX, INT_MIN));

        TEST_ASSERT_EQUAL_INT(INT_MAX - 1, f(INT_MIN, INT_MAX - 1));
        TEST_ASSERT_EQUAL_INT(INT_MAX - 1, f(INT_MAX - 1, INT_MIN));

        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MIN + 1, INT_MAX));
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MAX, INT_MIN + 1));

        TEST_ASSERT_EQUAL_INT(INT_MAX - 1, f(INT_MIN + 1, INT_MAX - 1));
        TEST_ASSERT_EQUAL_INT(INT_MAX - 1, f(INT_MAX - 1, INT_MIN + 1));

        // INT_MIN and INT_MIN
        TEST_ASSERT_EQUAL_INT(INT_MIN, f(INT_MIN, INT_MIN));
        TEST_ASSERT_EQUAL_INT(INT_MIN + 1, f(INT_MIN, INT_MIN + 1));
        TEST_ASSERT_EQUAL_INT(INT_MIN + 1, f(INT_MIN + 1, INT_MIN));
        TEST_ASSERT_EQUAL_INT(INT_MIN + 1, f(INT_MIN + 1, INT_MIN + 1));

        // INT_MAX and INT_MAX
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MAX, INT_MAX));
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MAX, INT_MAX - 1));
        TEST_ASSERT_EQUAL_INT(INT_MAX, f(INT_MAX - 1, INT_MAX));
        ...
        TEST_ASSERT_EQUAL_CHAR('b', (Max<IntWithId>{}(a, b).id));
        TEST_ASSERT_EQUAL_CHAR('a', (Max<IntWithId>{}(b, a).id));
    }
} // namespace T27
